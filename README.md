...
**Knowledge of:** `Git`, `GitHub`, `VsCode`, `HTML5`, `Responsive web design`, `CSS3`, `DOM`, `Javascript`(Vanilla, ES6), `jQuery`, `Bootstrap`, `ReactJS`, `Enzyme`, `Redux`, `AXIOS`, `3rd Party API`, `NoSQL databases`, `Postgres`, `MySQL`, `MongoDB`, `NodeJS`, `Jest`, `NPM`, `JSON`, `FontAwesome`, `Object-Oriented Programming`, `data structures and algorithms`.
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://codesandbox.io/u/Ahmad-Sawalqeh" target="blank"><img height="22" width="30" src="https://cdn4.iconfinder.com/data/icons/logos-brands-5/24/codesandbox-128.png" alt="Sandbox Account"></a>
</p>
